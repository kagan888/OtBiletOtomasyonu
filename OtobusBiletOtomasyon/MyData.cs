...
namespace OtobusBiletSatisi
{
    public static class MyData
    {
        ...
        public static DataTable DataTable_Otobus()
        {
            ...
            table_otobus.Rows.Add(recno, "16 ARS 38", 47);
            table_otobus.Rows.Add(recno, "34 BRA 28", 47);
            table_otobus.Rows.Add(recno, "16 JDD 99", 47);
            table_otobus.Rows.Add(recno, "16 DJ 145", 47);
